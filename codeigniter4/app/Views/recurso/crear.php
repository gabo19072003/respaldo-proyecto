  ...
  <div class="col-lg-12">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="form-sample" action="<?=site_url('recurso/guardar')?>" method="post" enctype="multipart/form-data">

                <?= csrf_field(); ?>

            <p class="card-description">Nuevo Recurso</p>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <label for="recurso_nro" class="col-sm-3 col-form-label">Número:</label>
                          <div class="col-sm-9">
                            <input id="recurso_nro" value="<?=old('recurso_nro')?>" type="text" class="form-control" name="recurso_nro"  placeholder="Ingrese el número de recurso">
                          </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <label for="recurso_nombre" class="col-sm-3 col-form-label">Información:</label>
                          <div class="col-sm-9">
                            <input id="recurso_nombre" value="<?=old('recurso_nombre')?>" type="text" class="form-control" name="recurso_nombre"  placeholder="Ingrese detalles del recurso">
                          </div>
                          <div class="col-sm-12 text-danger">
