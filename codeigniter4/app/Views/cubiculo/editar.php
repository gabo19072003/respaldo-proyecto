  ...
  <div class="col-lg-12">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="form-sample" action="<?=site_url('cubiculo/actualizar')?>" method="post" enctype="multipart/form-data">

            <?= csrf_field(); ?>

            <input type="hidden" name="cubiculo_id" value="<?=$cubiculo['cubiculo_id']?>">

            <p class="card-description">Editar Cubículo</p>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <label for="cubiculo_nro" class="col-sm-3 col-form-label">Número:</label>
                          <div class="col-sm-9">
                            <input id="cubiculo_nro" value="<?=$cubiculo['cubiculo_nro']?>" type="text" class="form-control" name="cubiculo_nro"  placeholder="Ingrese el número de cubiculo">
                          </div>
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="cubiculo_ubicacion">
                        <option value="" >Seleccione...</option>
                           <option value="1" <?= set_select('cubiculo_ubicacion', '1', ($cubiculo['cubiculo_ubicacion'] == '1')); ?>>Derecha</option>
                           <option value="0" <?= set_select('cubiculo_ubicacion', '0', ($cubiculo['cubiculo_ubicacion'] == '0')); ?>>Izquierda</option>
                      </select>
                    </div>
                    <div class="col-sm-12 text-danger">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <label for="cubiculo_detalles" class="col-sm-3 col-form-label">Información:</label>
                          <div class="col-sm-9">
                            <input id="cubiculo_detalles" value="<?=$cubiculo['cubiculo_detalles']?>" type="text" class="form-control" name="cubiculo_detalles"  placeholder="Ingrese detalles del cubiculo">
                          </div>
                          <div class="col-sm-12 text-danger">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="cubiculo_espacioso">
                        <option value="">Seleccione...</option>
                           <option value="1" <?= set_select('cubiculo_espacioso', '1', ($cubiculo['cubiculo_espacioso'] == '1')); ?>>Si</option>
                           <option value="0" <?= set_select('cubiculo_espacioso', '0', ($cubiculo['cubiculo_espacioso'] == '0')); ?>>No</option>
                      </select>
                    </div>
                    <div class="col-sm-12 text-danger">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                        ...
                        <div class="form-group row">
                          <label for="imagen" class="form-label">Subir Imagen de Escritorio</label>
                          <div class="col-sm-3">
                             <img class="img-thumbnail" src="<?=base_url()?>/public/uploads/<?=$cubiculo['cubiculo_escritorio'];?>" width="100" alt="<?=$cubiculo['cubiculo_escritorio'];?>">
                          </div>
                          <div class="col-sm-9">
                          ...
                          <option value="">Selecione...</option>
                           <?php
                            for ($silla = 1; $silla <= 12; $silla++) {
                                echo "<option value='$silla' ".set_select('cubiculo_silla',$silla, ($cubiculo['cubiculo_silla'] == $silla))." >$silla</option>";
                            }
                            ?>
                      </select> 
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="cubiculo_ventana">
                        <option value="">Seleccione...</option>
                           <option value="1" <?= set_select('cubiculo_ventana', '1', ($cubiculo['cubiculo_ventana'] == '1')); ?>>Si</option>
                           <option value="0" <?= set_select('cubiculo_ventana', '0', ($cubiculo['cubiculo_ventana'] == '0')); ?>>No</option>
                      </select>
                    </div>
                    <div class="col-sm-12 text-danger">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="cubiculo_redes">
                        <option value="">Seleccione...</option>
                           <option value="1" <?= set_select('cubiculo_redes', '1',($cubiculo['cubiculo_redes'] == '1')); ?>>Si</option>
                           <option value="0" <?= set_select('cubiculo_redes', '0',($cubiculo['cubiculo_redes'] == '0')); ?>>No</option>
                      </select>
                    </div>
                    <div class="col-sm-12 text-danger">
