...
<div class="container-fluid ">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <h1 class="col-md-9 h3 mt-1 ms-2 mb-0 text-gray-800">Eventos</h1>
        </div>
                          ...
                          foreach($eventos as $evento): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?=base_url('evento/suspender/'.$evento['id']);?>" class="btn py-0 me-2" title="Suspender evento"><i class="bi bi-bookmark-x fs-5"></i></a>
                                        <a href="<?=base_url('evento/editar/'.$evento['id']);?>" class="btn py-0 me-2" title="Editar evento"><i class="bi bi-pencil-square fs-5"></i></a>
