...
<div class="container-fluid ">
  ...
  <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Registros de Libros</h1>
  ...
  <div class="col-lg-12">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="form-sample" action="<?=site_url('libro/actualizar')?>" method="post" enctype="multipart/form-data">

              <?= csrf_field(); ?>

            <p class="card-description">Editar libro</p>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <label for="cota" class="col-sm-3 col-form-label">COTA:</label>
                          <div class="col-sm-9">
                            <input id="cota" value="<?=$libro['cota']?>" type="text" class="form-control" name="cota"  placeholder="Ingrese COTA">
                          </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <label for="nombre" class="col-sm-3 col-form-label">Nombre:</label>
                          <div class="col-sm-9">
                            <input id="nombre" value="<?=$libro['lib_nombre']?>" type="text" class="form-control" name="lib_nombre"  placeholder="Ingrese nombre">
                          </div>
                          <div class="col-sm-12 text-danger">
            ...
            <div class="row">
                  ...
                  <div class="col-md-6">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input id="editorial" value="<?=$libro['lib_editorial']?>" type="text" class="form-control" name="lib_editorial" placeholder="Ingrese editorial" />
                          </div>
                          <div class="col-sm-12 text-danger">
                  ...
                  <div class="col-md-6">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" id="autor" value="<?=$libro['lib_autor']?>" class="form-control" name="lib_autor" placeholder="Ingrese autor" >
                          </div>
                          <div class="col-sm-12 text-danger">
